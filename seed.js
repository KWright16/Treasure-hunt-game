...
batch.set(trailRef, {
    ...
    routeRef: 'projects/Tresure-hunt/databases/treasure-hunt-dcd8e/documents/routes/city-trail-route-1'
  })
  
const cityRouteRef = db.collection('routes').doc('city-trail-route-1')
batch.set(cityRouteRef, {locations: [{
   locationRef: 'projects/Tresure-hunt/databases/treasure-hunt-dcd8e/documents/locations/manc-town-hall',
   lat: 53.4781,
   long: -2.2441
}, {
    locationRef: 'projects/Tresure-hunt/databases/treasure-hunt-dcd8e/documents/locations/library', 
    lat: 53.4781,
    long: -2.2447
}, {
    locationRef: 'projects/Tresure-hunt/databases/treasure-hunt-dcd8e/documents/locations/chinaTown', 
    lat: 53.4784,
    long: -2.2399
}, {
    locationRef: 'projects/Tresure-hunt/databases/treasure-hunt-dcd8e/documents/locations/johnBright', 
    lat: 53.6146,
    long: -2.1623
}, {
    locationRef: 'projects/Tresure-hunt/databases/treasure-hunt-dcd8e/documents/locations/stAnn', 
    lat: 53.4817,
    long: -2.2458
}]})
...
batch.set(townHallRef, {
    ...
    challenge: 'I have 2 hands on my face; you check on me to keep your pace? (one word) ',
    answer: 'clock'
})
...
batch.set(johnBrightRef, {
    ...
    analysis: {statue: 0.99, sculpture: 0.96, monument: 0.96, memorial: 0.89, landmark: 0.94},
    answer: null
})
